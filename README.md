...
## Python Scripts
    ...
    All your files will be interpreted/compiled on Ubuntu 20.04 LTS using python3 (version 3.10.1)
    All your files should end with a new line
    The first line of all your files should be exactly #!/usr/bin/python3
    A README.md file, at the root of the folder of the project, is mandatory
    Your code should use the Pycode style (version 2.8 or more)
...
* **Ndubuisi Ollawwa** - [Ndollawa](https://github.com/Ndollawa)
